...
<button
	on:click={toggle}
	tabindex="0"
	class=" z-100 fixed right-0 top-0 m-[22px] size-[85px] rounded-full border-4 border-yellow-400 text-6xl text-yellow-300 transition-all hover:bg-[hsl(210,55%,8%,0.4)] hover:color"
