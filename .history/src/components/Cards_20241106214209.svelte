...
>
	{#each concepts as concept}
		<div
			class="grid w-full place-items-center mb-4 rounded-xl border-2 border-blue-900 pb-6"
		>
			<img
				src={concept.image}
				class=" w-full object-cover rounded-t-xl h-full "
				loading="lazy"
				alt="tech used"
			/>
			<div class=" grid">
				<h2 class="text-xl  grid font-bold text-white py-6">{concept.name}</h2>
			</div>
			...
			<button
				...
				><a href="/{concept.url}">Learn more</button
			>
		</div>
	{/each}
</section>
