...
<section class="h-1/2  grid items-center grid-cols-1 lg:grid-cols-2 pb-8 place-items-center place-self-center place-content-center z-10 text-start text-pretty">
	<img
