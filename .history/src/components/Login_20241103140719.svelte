...
<div class="flex min-h-[60vh] items-center justify-center py-16">
	<div class="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg shadow-lg md:flex-row">
		...
		<div
			class="flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat p-24  md:w-1/2 bg-gradient-to-r from-[hsla(54,61%,52%,1)] to-[hsla(179,79%,43%,1)] "
		>
			<!-- Google Login Button -->
			<div
				id="g_id_onload"
