...
>
	{#each concepts as concept}
		...
		>
			...
			<div
				class=" row-span-12 my-5 w-full grid grid-rows-subgrid place-items-start items-start gap-4 text-pretty border border-transparent bg-[--cardbg-color] px-4 pt-7 pb-6 text-center"
			>
