<article class=" grid items-center justify-center gap-4 my-8 place-self-center py-6 text-sky-100">
...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center gap-8 text-pretty px-8 pb-0 text-center  md:grid-cols-2"
>
	<figure class=" ">
		<img
