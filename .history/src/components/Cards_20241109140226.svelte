...
<section class="py-8 grid gap-8 md:grid-cols-2 md:gap-8 md:px-8 xl:grid-cols-3">
	{#each concepts as concept}
		...
		>
			...
			<div
				class="grid grid-cols-subgrid place-items-start items-start text-pretty text-center md:text-lg lg:text-xl gap-4"
			>
				{#each concept.features as feature}
					<p
						class="mx-auto w-[42ch] text-balance px-0  font-normal text-[--text-color]  text-sm base:text-lg md:text-lg lg:text-lg"
					>
						{feature}
					</p>
				{/each}
