...
<section
	class="z-10 grid grid-cols-2 place-content-center place-items-start items-center place-self-center text-pretty pb-8 text-start lg:grid-cols-2 wax-w-60vw"
>
