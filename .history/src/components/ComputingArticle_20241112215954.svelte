...
>
	...
	<p
		class="ml-8 w-[35ch] text-balance px-6 text-left sm:w-[45ch] sm:pl-4 md:w-[35ch] lg:w-[50ch] xl:w-[60ch]"
	>
...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center gap-4 text-pretty px-8 pb-0 text-start md:grid-cols-2"
>
	<figure class=" ">
		<img
			class="mt-8 rounded-xl border-2 border-[hsla(184,69%,60%,1)]"
	...
	<div
		class="mx-auto my-8 flex flex-col items-center justify-center gap-0 px-4 pb-0 text-sky-100 md:my-32"
	>
		<header class="mx-auto py-4">
			<h2 class="text-3xl text-sky-400">Key concepts</h2>
		</header>
		<ul
			class="mb-8 w-[35ch] list-inside list-disc text-left sm:w-[45ch] md:mx-auto md:w-[35ch] lg:w-[50ch] xl:w-[60ch]"
		>
			<p>
			...
			<p>
				...
				<code
					class="text-semibold mx-auto
					 w-[40ch] text-center text-[clamp(0.8rem,2vw,1rem)] uppercase text-sky-400 underline underline-offset-8"
