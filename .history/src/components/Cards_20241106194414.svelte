...
>
	{#each plans as plan}
		...
		>
			...
			<div class="subgrid grid-col-4 grid text-pretty  text-sm pb-4 ">
				{#each plan.features as feature}
					<p class="max-w-[45ch] py-1 text-pretty text-white">{feature}</p>
				{/each}
			</div>
			<button

				type="button"
				class="action mx-auto mb-8 w-[180px] rounded border bg-indigo-500 px-4 py-2 text-white hover:bg-[hsl(210,55%,80%,1)]"
