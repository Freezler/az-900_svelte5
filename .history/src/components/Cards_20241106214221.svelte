...
>
	{#each concepts as concept}
		<div class="mb-4 grid w-full place-items-center rounded-xl border-2 border-blue-900 pb-6">
			<img
				src={concept.image}
			...
			<div class="grid-col-4 grid text-pretty pb-8 text-sm">
				{#each concept.features as feature}
					<p class="max-w-[40ch] text-pretty py-1 text-white">{feature}</p>
				{/each}
			</div>
			<button
				type="button"
