	...
	{#each concepts as concept}
		...
		>
			...
			<div class="grid grid-cols-subgrid  place-items-center items-center justify-center">
				<h2
					class="text-xl  mt-5 font-semibold text-[--text-color]  "
				>
					{concept.name}
				</h2>
			</div>
			...
			<div
				class="my-8 grid grid-rows-subgrid place-items-start items-start text-pretty text-center gap-4 row-span-12 "
			>
			...
			<button
				type="button"
				class="mx-auto my-1 w-[220px] grid-cols-subgrid rounded-xl border-[2px_solid_var(--text-color)] bg-sky-900 px-8 py-3 text-[--text-color] hover:bg-sky-500 hover:text-white transition duration-[300ms] hover:shadow-[2px_2px_42px_rgb(122,122,0,0.6)] text-base font-semibold md:text-lg lg:text-lg uppercase"
