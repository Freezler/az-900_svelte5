...
<section class="my-24 grid grid-cols-1 gap-4 md:px-8 md:grid-cols-2 md:gap-8 xl:grid-cols-3">
	{#each concepts as concept}
		<div
			class="my-0 gap-2 grid grid-cols-subgrid place-items-center items-center justify-center rounded-2xl border-2 border-blue-900 pb-6 z-100 overflow-hidden"
		>
			<img
				src={concept.image}
				class="h-[220px] w-[100%] grid-cols-subgrid border-b-2 min-w-0 object-cover aspect-[14/9] object-center "
				loading="lazy"
				alt="tech used"
			/>
