...
<div class="relative flex min-h-[60vh] items-center justify-center py-16 ">
	<div class="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg shadow-lg md:flex-row">
		...
		>
			...
			<!-- Email Login Button -->
			<button
				class="flex w-3/5 items-center justify-center space-x-2 rounded-full border border-gray-300 bg-white py-2 shadow-md hover:bg-gray-50 focus:outline-none mb-8"
			>
