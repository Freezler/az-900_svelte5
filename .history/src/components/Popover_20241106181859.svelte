...
<button
	...
	class="fixed right-[8px] top-[8px] flex h-12 w-12 items-center justify-center rounded-full bg-gray-200 z-100"
>
	<svg
...
{#if showMenu}
	<ul
		class="fixed right-0 top-0 grid h-[24vh] w-full place-items-center justify-around
		border bg-white shadow-lg z-10"
