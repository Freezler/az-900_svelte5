...
<div class="min-h-[60vh] flex items-center justify-center  p-16">
  <div class="flex flex-col md:flex-row w-full max-w-4xl  rounded-lg shadow-lg overflow-hidden">
    <!-- Left side: Logo and Welcome message -->
    <div class="md:w-1/2 flex flex-col items-center justify-center p-14 bg-center obejct-cover bg-cover bg-[url('./headImage.png§')] text-white">
