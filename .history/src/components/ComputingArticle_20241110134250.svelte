...
<section class="h-full  grid items-center grid-cols-1 lg:grid-cols-2 pb-8 place-items-center place-self-center place-content-center z-10 text-start text-pretty">
	<img
		src="../public/images/cloud.png"
		alt="cloudSolutions"
		loading="lazy"

		class="  box-content place-self-center   drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] "
	/>
	<article
