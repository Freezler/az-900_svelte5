...
{#if status === 'Fade_IN'}
	<div
		class=" duration-200 animate-fade-out  card-wrapper  h-[500px] w-[382px] rounded bg-white text-center"
		popover="auto"
		id="nav-menu"
	>
...
{#if status === 'Fade_OUT'}
  <div
    class=" animate-fade-in duration-200  delay-500 card-wrapper h-[500px] w-[382px] rounded bg-white text-center"
    popover="auto"
    id="nav-menu"
  >
    <div class="card-content">
