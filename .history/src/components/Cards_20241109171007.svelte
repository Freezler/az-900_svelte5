...
>
	{#each concepts as concept}
		...
		>
			...
			<div
				class=" row-span-12 my-5 w-full grid grid-rows-subgrid place-items-start items-start gap-4 text-pretty border border-transparent bg-sky-500/10 px-4 py-7 text-center"
			>
