<div class="grid items-center justify-center gap-4 place-self-center text-sky-100 w-[45ch] md:w-[75ch]  md:pl-8 py-4 mt-6">
...
<section class="w-10/12 grid items-center grid-cols-1 lg:grid-cols-2 justify-around pb-6 place-items-center place-self-center place-content-center z-10 text-start text-pretty">
	<img
		src="../public/images/cloud.png"
		alt="cloudSolutions"
		loading="lazy"

		class="scale-[1.4] sm:-translate-y-16  -translate-y-14 w-full max-w-[520px] min-w-[400px] rounded-2xl overflow-hidden mr-16  md:mr-16 drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] "
	/>
	<article
		class=" text-sky-100 px-0 gap-0 flex flex-col  place-items-start items-cemter justify-center  w-[45ch] md:w-[52ch] md:mt-0 pb-8 md:pt-8"
	>
