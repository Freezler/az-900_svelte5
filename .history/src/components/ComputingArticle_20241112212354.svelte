...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center px-8  text-pretty pb-0 text-start sm:grid-cols-2 min-w-50vw"
>
	<figure class=" ">
		<img
	...
	<div
		class="items-center justify-center mx-auto flex   flex-col  gap-0 pb-0 text-sky-100 px-8 mt-4  mb-12"
	>
		<header class="mx-auto  pb-4">
			<h2 class="text-3xl text-sky-400">Key concepts</h2>
		</header>
		<ul class="w-[35ch] sm:w-[40ch] md:w-[45ch] xl:w-[62ch] list-inside list-disc text-left md:mx-auto">
			<li>
