...
<section
	class="z-10 grid grid-cols-1 place-content-center place-items-start items-center place-self-center text-pretty pb-8 text-start lg:grid-cols-2 wax-w-60vw"
>
	<figure class="mr-0 place-self-center box-content -translate-y-24 place-self-center drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))]">
		<img
