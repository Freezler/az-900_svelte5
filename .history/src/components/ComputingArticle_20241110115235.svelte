<div class="grid items-center justify-center gap-8 place-self-center text-sky-100 w-[45ch] md:w-[75ch] md:text-center md:pl-8 pt-10">
	<h2 class="text-3xl text-center text-sky-400">Cloud Computing</h2>
	<p class="text-left rounded-3xl text-balance px-2 ml-12">
