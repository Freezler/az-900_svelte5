...
<section
	class=" mx-auto mb-16 grid grid-cols-1  md:grid-cols-2 md:gap-4 md:px-4 lg:grid-cols-3"
	...
	{#each plans as plan}
		...
		>
			...
			<div class="subgrid grid">
				<h2 class="subgrid text-base grid font-bold text-white">{plan.name}</h2>
			</div>
			<div class="subgrid grid-col-4 grid text-pretty p-8 text-sm">
