		...
		>
			...
			>
				{#each concept.features as feature}
					<h3
						class="border-b-1 mx-auto mb-0 grid w-[35ch]  grid-rows-subgrid text-balance border-[--text-color] px-0 text-[12px] font-normal leading-snug tracking-wider text-sky-200 py-0 first:border-t-2 first:pt-2 last:pb-6 last:border-b-2 lg:text-[16px] border-s-fuchsia-400 ">
						{feature}
					</h3>
				{/each}
			</div>
