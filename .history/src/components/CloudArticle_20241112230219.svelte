<article class=" grid items-center justify-center gap-4 place-self-center py-6 text-sky-100">
	<header class="text-center">
		<h2 class="text-3xl text-sky-400">Cloud Computing</h2>
	</header>
	<p class="text-balance text-center sm:pl-4">
...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center gap-8 text-pretty px-8 pb-0 text-center text-pretty md:grid-cols-2"
>
	<figure class=" ">
		<img
			class="mb-6 rounded-xl border-2 border-[hsla(184,69%,60%,1)] md:w-full md:h-[400px] mt-8 md:mt-0"
	...
	<div
		class="mx-auto  flex flex-col  text-sky-100 md:my-16"
	>
		<header class="mx-auto ">
			<h2 class="text-3xl text-sky-400 mb-8">Key concepts</h2>
		</header>
		<ul
		...
		>
			...
			<p
				class="text-bold place-self-center

				pb-20 text-center text-3xl
