...
<div>
  ...
  <div
    ...
    class=" absolute right-0 top-0  h-[500px] w-[382px] rounded border-2 border-blue-600 bg-white text-center"
    popover="auto"
    id="nav-menu"
  >
		<ul class="card-wrapper  h-full grid place-items-center items-center justify-center gap-4">

			<li class="card-content">HOME</li>
			<li class="card-content">ABOUT ME</li>
			<li>PROJECTS</li>
			<li>CONTACT</li>
		</ul>
	</div>
