...
<button
	on:click={toggle}
	tabindex="0"
	class="fixed rounded-full  right-0 top-0 size-[90px]  m-[20px] border-4 text-2xl text-white hover:bg-[hsl(210,55%,8%,0.4)] transition-all"
	aria-expanded={isMenuOpen}
	aria-controls="menu"
	aria-label="open menu"
><img src="fab fa-bars" alt="" srcset="">
