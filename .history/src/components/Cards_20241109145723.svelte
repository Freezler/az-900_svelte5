...
<section class="py-8 grid gap-8 md:grid-cols-2 md:gap-8 md:px-8 xl:grid-cols-3 grid-rows-1">
	{#each concepts as concept}
		<div
			class=" my-0  grid  place-items-center  overflow-hidden rounded-2xl border-2 border-[--text-color] pb-6 shadow-[0_4px_12px_rgba(255,255,99,0.9)] brightness-90 transition duration-300 hover:scale-[1.001]   bg-yellow-600/10 hover:shadow-[2px_6px_12px_rgba(25,322,0.9)] "
		>
			<img
				src={concept.image}
