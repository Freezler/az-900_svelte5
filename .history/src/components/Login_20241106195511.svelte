...
<div class="flex min-h-[60vh] items-center justify-center py-16 ">
	<div class="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg shadow-lg md:flex-row">
		...
		<div
			class="-z-10 flex flex-col items-center justify-center bg-[url('/public/images/headImage.png')] bg-cover bg-center object-cover p-14 text-white md:w-1/2 "
		>
			<img
		...
		<div
			class="flex flex-col items-center justify-center  bg-blue-600/40 backdrop-blur pt-8"
		>
			<!-- Google Login Button -->
			<div
				id="g_id_onload"
			...
			<div class="pb-0 pt-4 w-full text-center">
