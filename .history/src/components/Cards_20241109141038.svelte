...
<section class="py-8 grid gap-8 md:grid-cols-2 md:gap-8 md:px-8 xl:grid-cols-3">
	{#each concepts as concept}
		<div
			class="z-100 my-0 gap-4 grid grid-cols-subgrid  place-items-center  overflow-hidden rounded-2xl border-2 border-[--text-color] pb-6 shadow-[0_4px_12px_rgb(122,122,0,0.6)] transition duration-300 hover:scale-[1.01]   bg-yellow-600/10 hover:shadow-[0_8px_22px_rgb(122,122,0,0.6)] h-full"
		>
			<img
				src={concept.image}
