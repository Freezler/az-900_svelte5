...
<div>
  ...
  <div
    ...
    class="card-wrapper  absolute right-0 top-0  h-[500px] w-[382px] rounded border-2 border-blue-600 bg-white text-center"
    popover="auto"
    id="nav-menu"
  >
		<ul class="card-content h-full grid place-items-center items-center justify-center gap-4">
