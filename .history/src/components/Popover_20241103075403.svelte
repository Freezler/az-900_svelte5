...
<img src="./Design 2.png" class="w-20 fixed top-0 left-0 m-4 hover:opacity-15 transition-all" alt="otter logo">


<button
	on:click={toggle}
	tabindex="0"
	class="fixed rounded-full  right-0 top-0 w-[94px] h-[94px] font-bold m-6 border-2 text-2xl text-white hover:bg-blue-700"
