...
<section class="w-3/4 h-[500px]grid items-center grid-cols-1 lg:grid-cols-2 justify-around place-items-center place-self-center place-content-center gap-0	z-10 text-start">
	<img
		src="../public/images/cloud.png"
		alt="cloudSolutions"
		loading="lazy"

		class=" w-full  mx-auto rounded-2xl overflow-hidden  drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] "
	/>
	<article
