...
<section class="my-24 grid grid-cols-1 gap-4 md:px-8 md:grid-cols-2 md:gap-8 xl:grid-cols-3">
	{#each concepts as concept}
		<div
			class="my-0 gap-2 grid grid-cols-subgrid place-items-center items-center justify-center rounded-xl border-2 border-blue-900 pb-6"
		>
			<img
				src={concept.image}
				class="h-[220px] w-full grid-cols-subgrid rounded-t-xl object-cover aspect-[16/9] object-center"
				loading="lazy"
				alt="tech used"
			/>
