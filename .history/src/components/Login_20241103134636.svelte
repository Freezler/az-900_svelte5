...
<div class="min-h-[60vh] flex items-center justify-center  py-16">
  <div class="flex flex-col md:flex-row w-full max-w-4xl  rounded-lg shadow-lg overflow-hidden">
    ...
    <div class="md:w-1/2 flex flex-col items-center justify-center p-14 bg-center object-cover bg-cover bg-[url('/public/images/headImage.png')] text-white">
    ...
    <div class="md:w-1/2 flex flex-col items-center justify-center p-24 backdrop-brightness-[.50] backdrop-blur-md  bg-no-repeat bg-cover bg-center">
      <!-- Google Login Button -->
      <div id="g_id_onload"
