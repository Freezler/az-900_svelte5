...
<section class=" grid items-center grid-cols-1 lg:grid-cols-2 pb-8 place-items-start place-self-center place-content-center z-10 text-start text-pretty pl-24">
	<img
