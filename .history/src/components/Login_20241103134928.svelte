...
<div class="flex min-h-[60vh] items-center justify-center py-16">
	<div class="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg shadow-lg md:flex-row">
		...
		>
			...
			/>
			<h2 class="text-4xl font-semibold p-2 text-white backdrop-brightness-[.70] backdrop-blur-md ">Good Evening {user}!</h2>
			<p class="mt-2 text-center text-lg  p-2 backdrop-brightness-[.10] backdrop-blur-md ">Log in to your account!</p>
		</div>
