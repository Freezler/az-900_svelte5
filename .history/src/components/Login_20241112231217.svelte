...
<div class="relative flex  items-center justify-center pt-16 ">
	<div class="flex w-full max-w-4xl flex-col overflow-hidden rounded-lg shadow-lg md:flex-row">
		<!-- Left side: Logo and Welcome message -->
		<div
			class="flex flex-col items-center justify-center bg-[url('/public/images/headImage.png')] bg-cover bg-center object-cover p-14 text-white md:w-full "
		>
			<img
		...
		<div
			class="flex flex-col items-center justify-center text-center h-[32vh] bg-blue-600/40"
		>
			<!-- Google Login Button -->
			<!-- <div
				id="g_id_onload"
			...
			<button
				class="flex w-3/5 items-center justify-center space-x-2 rounded-full border border-gray-300 bg-white py-2 shadow-md hover:bg-gray-50 focus:outline-none mt-6"
			>
			...
			<!-- Email Login Button -->
			<button
				class="flex w-3/5 items-center justify-center space-x-2 rounded-full border border-gray-300 bg-white py-2 shadow-md hover:bg-gray-50 focus:outline-none"
			>
				<span class=" text-gray-500"></span>
			...
			<div class=" w-full text-center mt-8">
				...
				<p class="mx-auto text-xs text-gray-500 w-[35ch] text-center">
