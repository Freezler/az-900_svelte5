<div class="grid items-center justify-center gap-4 place-self-center text-sky-100 w-[45ch] md:w-[75ch]  md:pl-8 pt-10">
...
<section class="w-8/12 grid items-center grid-cols-1 lg:grid-cols-2 justify-around place-items-center place-self-center place-content-center gap-0	z-10 text-start">
	<img
		src="../public/images/cloud.png"
		alt="cloudSolutions"
		loading="lazy"

		class=" w-[720px] -mt-16 mx-auto rounded-2xl overflow-hidden  drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] "
	/>
	<article
