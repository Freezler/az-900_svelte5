...
<section class="w-8/12 grid items-center grid-cols-1 lg:grid-cols-2 justify-around pb-20 place-items-center place-self-center place-content-center gap-16 z-10 text-start">
	...
	/>
	<article
		class=" text-sky-100 px-0 gap-0 flex flex-col  place-items-start items-cemter justify-center -translate-y-24 w-[45ch] md:w-[52ch] md:mt-20 "
	>
		<h2 class="text-3xl pb-4 mx-auto text-sky-400 ">Key concepts</h2>
		<ul class="list-inside list-disc pl-4 text-md md:w-[40ch] md:mx-auto">
			<li>
