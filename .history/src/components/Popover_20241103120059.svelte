...
{#if isMenuOpen}
	<div
		class="z-100 fixed bottom-0 left-0 mt-auto h-[42vh] w-full bg-white text-center"
		id="menu"
		role="menu"
	...
	>
		<ul class="flex h-full w-full flex-col place-items-center items-center justify-center gap-4 bg">
			<li role="none">
