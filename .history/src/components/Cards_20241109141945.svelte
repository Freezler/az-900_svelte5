...
<section class="py-8 grid gap-2 md:grid-cols-2 md:gap-8 md:px-8 xl:grid-cols-3 grid-rows-1">
	{#each concepts as concept}
		...
		>
			<img
				src={concept.image}
				class=" w-full aspect-w-13 aspect-h-11  border-b-2 border-[--text-color] object-cover object-center"
				loading="lazy"
				alt="tech used"
			/>
			<div class="grid grid-cols-subgrid  place-items-center items-center justify-center">
				<h2
					class="text-xl  font-semibold text-[--text-color]  "
				>
					{concept.name}
				</h2>
			</div>
			...
			<div
				class="grid grid-rows-subgrid place-items-start items-start text-pretty text-center gap-4 row-span-5 "
			>
