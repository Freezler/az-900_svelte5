...
>
	...
	<p class="ml-8 w-[35ch] sm:w-[45ch] md:w-[35ch] lg:w-[50ch] xl:w-[60ch] text-balance px-6 text-left  sm:pl-4">
...
>
	...
	>
		...
		<ul class="w-[35ch] sm:w-[45ch] md:w-[35ch] lg:w-[50ch] xl:w-[60ch] list-inside list-disc text-left md:mx-auto mb-8">
			<p>
			...
			<p>
				...
				<code
					class="text-semibold w-40ch
					 mx-auto text-center text-[clamp(0.8rem,2vw,1rem)] uppercase text-sky-400 underline underline-offset-8"
