...
<section class="py-8 grid gap-8 md:grid-cols-2 md:gap-8 md:px-8 xl:grid-cols-3">
	{#each concepts as concept}
		...
		>
			<img
				src={concept.image}
				class="h-[220px] w-[100%] mb-4  border-b-2 border-[--text-color] object-fit object-center"
				loading="lazy"
				alt="tech used"
			/>
			<div class="grid-cols-subgrid  place-items-center items-center justify-center">
				<h2
					class="text-xl border-b my-4 border-[--text-color] font-semibold text-[--text-color] md:text-2xl  "
				>
					{concept.name}
				</h2>
			</div>
