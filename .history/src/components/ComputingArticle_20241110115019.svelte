<div class="grid items-center justify-center gap-8 place-self-center text-sky-100 w-[45ch] pt-10">
...
<section class="w-3/4 grid items-center grid-cols-1 lg:grid-cols-2 justify-around place-items-center place-self-center place-content-center gap-0	z-10 text-start">
	<img
		...
		class=" w-[700px] h-[400px]  mx-auto rounded-2xl overflow-hidden  pr-12 -mt-8 drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] "
	/>
	<article
