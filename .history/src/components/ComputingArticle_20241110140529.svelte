<div class="grid items-center justify-center gap-4 place-self-center text-sky-100 w-[45ch] md:w-[75ch]  md:pl-8 py-6 mt-6">
	...
	<p class="text-balance text-left w-[45ch] px-6 sm:w-[62ch]  sm:pl-16">
...
<section class=" grid items-center grid-cols-1 lg:grid-cols-2 pb-8 place-items-start place-self-center place-content-center z-10 text-start text-pretty">
	...
	/>
	<article
		class=" text-sky-100 px-0 gap-0 flex flex-col  place-items-center items-cemter justify-center place-content-center w-[45ch] md:w-[52ch] md:-mt-28 pb-0 -translate-y-40 sm:-translate-y-8 md:translate-y-[-4px] mx-auto"
	>
		<h2 class="text-3xl pb-4 mx-auto text-sky-400 mt-10  ">Key concepts</h2>
		<ul class="list-inside list-disc text-left ml-12 mx-auto md:w-[45ch] md:mx-auto  ">
			<li>
