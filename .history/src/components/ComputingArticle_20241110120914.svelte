	...
	>
		...
		<ul class="list-inside list-disc pl-4 text-[clamp(0.5rem,2vw,1rem]">
			...
			<li>
				...
				is a simple calculation of system uptime versus the whole lifetime of the system:<br /> <pre class="text-ctext-sky-500 pt-4 text-[clamp(0.5rem,2vw,1rem)]">availability = uptime / (uptime + downtime)</pre>
			</li>
		</ul>
	</article>
</section>