...
<section
	class="z-10 grid grid-cols-1 place-content-center place-items-start items-center place-self-center text-pretty pb-0 text-start sm:grid-cols-2 wax-w-60vw"
>
