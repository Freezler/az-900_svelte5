...
>
	...
	<div
		class="items-center mx-auto flex w-[35ch] -translate-y-40 flex-col place-content-center place-items-center justify-center gap-0 px-0 pb-0 text-sky-100   md:w-[52ch] md:translate-y-[-4px]"
	>
