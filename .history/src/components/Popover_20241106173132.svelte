...
/*************  ✨ Codeium Command 🌟  *************/
			...
			/>
			<path in:receive out:send stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
		{:else}
			<path
				in:receive={{ key: "open" }}
				out:send={{ key: "open" }}
			...
			/>
			<path in:receive out:send stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
/******  d60c52d3-7496-443f-887e-c7837973caa5  *******/
		{/if}
	</svg>
</button>
