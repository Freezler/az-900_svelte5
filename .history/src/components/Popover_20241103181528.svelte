...
>
	...
	{#if isMenuOpen}
		<svg xmlns="http://www.w3.org/2000/svg" width="2.8rem" height="2.6rem" viewBox="0 0 18 25" {...$$props}><path fill="currentColor" d="M3 18h18v-2H3zm0-5h18v-2H3zm0-7v2h18V6z" class="fill-current"/></svg>
	{#if !isMenuOpen}
