...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center px-8  text-pretty pb-0 text-start md:grid-cols-2 min-w-50vw"
>
	<figure class=" ">
		<img
			class="border-2 rounded-xl border-[hsla(184,69%,60%,1)]"
	...
	<div
		class="items-center justify-center mx-auto flex   flex-col  gap-0 pb-0 text-sky-100 px-8 mt-4  my-12 md:my-24"
	>
		<header class="mx-auto  pb-4">
			<h2 class="text-3xl text-sky-400">Key concepts</h2>
		</header>
		<ul class="w-[25ch] sm:w-[25ch] md:w-[35ch] xl:w-[60ch] list-inside list-disc text-left md:mx-auto">
			<li>
