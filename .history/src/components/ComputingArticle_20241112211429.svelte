...
<section
	class="z-10 grid grid-cols-1   text-pretty pb-0 text-start sm:grid-cols-2 min-w-50vw"
>
	<figure class="mr-0 box-content -translate-y-24 place-self-center drop-shadow-[(0_0px_22px_rgba(255,255,99,0.2))] ">
		<img
			class="border-2 max-h-[300px]  border-[hsla(184,69%,60%,1)]"
			src="https://images.unsplash.com/photo-1573220606811-bb3dce8a99ba?q=80&w=3087&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
			alt="cloudadvantage"
			loading="lazy"
		/>
	</figure>
	...
	>
		<header class="mx-auto mt-16 pb-4">
