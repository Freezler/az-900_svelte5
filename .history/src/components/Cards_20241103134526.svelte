...
>
	{#each plans as plan}
		<div
			class=" subgrid grid w-full place-items-center gap-4 mb-8 rounded-2xl border-2 border-yellow-300 backdrop-brightness-[.50] backdrop-blur-md pb-6"
		>
			<img
				src={plan.image}
			...
			<button
				type="button"
				class="action mx-auto my-4 w-[180px] rounded border bg-indigo-500 px-4 py-2 text-white hover:bg-[hsl(210,55%,80%,1)]"
				>learn more</button
			>
		</div>
	{/each}
