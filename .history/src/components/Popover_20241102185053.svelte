...
<img src="./Design 2.png" class="w-20 fixed top-0 left-0 m-4 hover:opacity-15 transition-all pointer-events-none" alt="otter logo">


<button
	on:click={toggle}
	tabindex="0"
	class="fixed right-0 top-0 rounded border px-4 py-2 font-bold text-white hover:bg-blue-700"
