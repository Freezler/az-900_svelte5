...
<section class=" grid items-center grid-cols-1 lg:grid-cols-2 pb-8 place-items-start place-self-center place-content-center z-10 text-start text-pretty">
	...
	/>
	<article
		class=" text-sky-100 px-0 gap-0 flex flex-col  place-items-center items-cemter justify-center place-content-center w-[45ch] md:w-[52ch] md:-mt-28 pb-0 -translate-y-40 sm:-translate-y-8 md:translate-y-[-4px] w-full "
	>
