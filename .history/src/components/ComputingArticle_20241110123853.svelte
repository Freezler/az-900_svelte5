...
<section class="w-8/12 grid items-center grid-cols-1 lg:grid-cols-2 justify-around pb-8 place-items-center place-self-center place-content-center gap-5 z-10 text-start text-pretty">
	<img
