...
<section
	class="z-10 grid grid-cols-1 place-items-center items-center justify-center px-8 pag-8 text-pretty pb-0 text-start md:grid-cols-2 min-w-50vw"
>
	<figure class=" ">
		<img
	...
	<div
		class="items-center justify-center mx-auto flex   flex-col  gap-0 pb-0 text-sky-100 px-8 my-8   md:my-20"
	>
